...
| Semana 4 | Implementación funcional del MVP Android y organización de evidencias arquitectónicas. | Código fuente del proyecto y `docs/semana-04/` |
...
| Evidencia ejecutable | [04-evidencia-ejecutable](dossier/04-evidencia-ejecutable.md) |
...
|---|---|
| Rama actual | `master` |
| HEAD registrado | `0f13f0d01ca9e0f261632882f8a927a4fbdc8bb5` |
| Commit de línea base para Semana 4 | PENDIENTE DE FIJAR |
| Historial disponible | 2 commits registrados |
...
El repositorio contiene cambios locales posteriores al commit `0f13f0d`.

Por esta razón, el commit definitivo utilizado como línea base para la medición de Semana 4 todavía está pendiente de fijar.
